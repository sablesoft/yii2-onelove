...
return [
    ...
    'File upload failed.' => '',
    'Home' => 'Главная',
    'If you forgot your password you can {0}' => 'Если вы забыли пароль, то можете {0}',
    ...
    'Please fill out the following fields to signup' => 'Пожалуйста, заполните необходимые поля чтобы зарегистрироваться',
    ...
    '{attribute} must be no greater than {max}.' => '{attribute} допустим только не более чем {max}.',
    '{attribute} must be no less than {min}.' => '{attribute} допустим только не менее чем {min}.',
    ...
    '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.'
        => '{attribute} должен содержать как минимум {min, number} {min, plural, {символ} other{символов}}.',
    ...
    '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.'
        => '{attribute} должен содержать {length, number} {length, plural, one{символ} other{символов}}.',
