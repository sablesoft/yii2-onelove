...
return [
    ...
    'Save' => 'Сохранить',
    'Search' => 'Искать',
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.' => 'Показаны <b>{begin, number}-{end, number}</b> из <b>{totalCount, number}</b> {totalCount, plural, one{элемента} other{элементов}}.',
    'Signup' => 'Регистрация',
    'The above error occurred while the Web server was processing your request.' => '',
    'The combination {values} of {attributes} has already been taken.' => 'Сочетание {values} для {attributes} уже существует.',
    ...
    '{attribute} must be a number.' => 'Значение "{attribute}" должно быть целым числом.',
    '{attribute} must be a string.' => '',
    '{attribute} must be a valid IP address.' => '',
    '{attribute} must be an IP address with specified subnet.' => '',
    '{attribute} must be an integer.' => 'Значение "{attribute}" должно быть числом.',
    ...
    '{attribute} must be no greater than {max}.' => '{attribute} допустим не более {max}.',
    '{attribute} must be no less than {min}.' => '{attribute} допустим не менее {min}.',
    ...
    '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.' => '{attribute} должен содержать как минимум {min, number} {min, plural, {символ} other{символов}}.',
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => '',
    '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.' => '{attribute} должен содержать {length, number} {length, plural, one{символ} other{символов}}.',
